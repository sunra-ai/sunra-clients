...
const main = async () => {
  try {
    ...
    if (data) {
      ...
      //     message: 'Insufficient credit for freeze_credit: required 0.04, available 0',
      //     details: {
      //       required: '0.04',
      //       available: '0',
      //       customerId: 'org_xxxx',
      ...
      //     }
      //   },
      //   timestamp: '2025-07-15T08:01:43.820Z',
      //   path: '/queue/black-forest-labs/flux-kontext-pro/text-to-image'
      // }
