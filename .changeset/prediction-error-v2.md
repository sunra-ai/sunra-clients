...
Carry the prediction error contract v2 (`reason`, `retryable`) through all three SDKs, and unpack the `PREDICTION_FAILED` body the queue result endpoint now returns for a failed prediction (SUNRA-849 Phase 4a).
